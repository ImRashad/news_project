...
<?php }  ?>
                ...
                <div class="row">
                 ...
                 <input type="submit" class="btn btn-success" name="haberkaydet" value="Haber Kaydet">
                         <hr>
                        ...
                        <div class="">
                            ...
                            <input class="col-md-6" type="text" required="" name="haber_ad" placeholder="Haber adi gir...">
                            <br><br>
